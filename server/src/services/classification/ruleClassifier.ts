...
const FILENAME_PATTERNS: Array<{ pattern: RegExp; docClass: DocClass; confidence: number }> = [
  { pattern: /paystub|pay.?stub|earnings.?statement/i, docClass: 'payStub.us', confidence: 0.70 },
  { pattern: /w-?2|wage.?and.?tax/i, docClass: 'tax.us.w2', confidence: 0.75 },
  { pattern: /1099/i, docClass: 'tax.us.1099', confidence: 0.75 },
  { pattern: /1040|tax.?return/i, docClass: 'tax.us.1040', confidence: 0.75 },
  { pattern: /bank.?statement|checking.?statement/i, docClass: 'bankStatement.us.checking', confidence: 0.65 },
  { pattern: /savings.?statement/i, docClass: 'bankStatement.us.savings', confidence: 0.65 },
  { pattern: /credit.?card.?statement/i, docClass: 'creditCard', confidence: 0.65 },
...
const CONTENT_PATTERNS: Array<{ pattern: RegExp; docClass: DocClass; confidence: number }> = [
  { pattern: /pay\s*statement|earnings\s*statement|pay\s*period/i, docClass: 'payStub.us', confidence: 0.90 },
  { pattern: /gross\s*pay.*net\s*pay|net\s*pay.*gross\s*pay/i, docClass: 'payStub.us', confidence: 0.88 },
  { pattern: /wage\s*and\s*tax\s*statement|form\s*w-?2/i, docClass: 'tax.us.w2', confidence: 0.95 },
  { pattern: /form\s*1099/i, docClass: 'tax.us.1099', confidence: 0.90 },
  { pattern: /form\s*1040|u\.?s\.?\s*individual\s*income\s*tax/i, docClass: 'tax.us.1040', confidence: 0.92 },
  { pattern: /statement\s*period.*checking|checking.*account\s*statement/i, docClass: 'bankStatement.us.checking', confidence: 0.88 },
  { pattern: /statement\s*period.*savings|savings.*account\s*statement/i, docClass: 'bankStatement.us.savings', confidence: 0.88 },
  { pattern: /account\s*statement.*beginning\s*balance|beginning\s*balance.*ending\s*balance/i, docClass: 'bankStatement.us.checking', confidence: 0.80 },
  { pattern: /credit\s*card\s*statement|previous\s*balance.*new\s*charges/i, docClass: 'creditCard', confidence: 0.88 },
